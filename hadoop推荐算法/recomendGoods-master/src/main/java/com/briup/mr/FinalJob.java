...
//        Path seven_output = new Path("C:\\Users\\ASUS\\Desktop\\briup\\大数据\\out77");
        ...
        Path input = new Path("/intput/input.txt");
        Path one_output = new Path("/user/out11");
        Path two_output = new Path("/user/out22");
        Path three_output = new Path("/user/out33");
        Path four_output = new Path("/user/out44");
        Path five_output = new Path("/user/out55");
        Path six_output = new Path("/user/out66");
        Path seven_output = new Path("/user/out77");
        ...
        DBConfiguration.configureDB(job7.getConfiguration(), "com.mysql.cj.jdbc.Driver",
                "jdbc:mysql://47.104.206.142:33060/briup", "root", "123456");
        DBOutputFormat.setOutput(job7, "briup", "uid", "gid", "nums");
